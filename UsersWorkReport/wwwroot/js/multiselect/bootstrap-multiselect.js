...
!function ($) {
    ...
    Multiselect.prototype = {
        defaults: {
            ...
            nonSelectedText: '<span> Select </span>',
            nSelectedText: 'selected',
            numberDisplayed: 3
        },

        templates: {
            button: '<button type="button" class="multiselect dropdown-toggle d-flex justify-content-between" data-toggle="dropdown"></button>',
            ul: '<ul class="multiselect-container dropdown-menu p-2"></ul>',
            filter: '<div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-search"></i></span><input class="form-control multiselect-search" type="text"></div>',
            li: '<li class="mb-1"><a href="javascript:void(0);"><label></label></a></li>',
